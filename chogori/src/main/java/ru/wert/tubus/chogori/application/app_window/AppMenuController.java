...
import ru.wert.tubus.chogori.application.app_window.test.FillDecimals;
import ru.wert.tubus.chogori.application.app_window.test.FillPassports;
...
//        editorMenu.getItems().add(catalogOfProductItem);
    ...
    private Menu createAdminMenu() {
        ...
        //Меняю только для разработчика для внедрения журнала регистрации
        MenuItem fillPassports = new MenuItem("Заполнить паспорта");
        fillPassports.setOnAction(FillPassports::fill);

        //Меняю только для разработчика для внедрения журнала регистрации
        MenuItem fillDecimals = new MenuItem("Заполнить децимальные группы");
        fillDecimals.setOnAction(FillDecimals::fill);
        ...
        adminMenu.getItems().add(new SeparatorMenuItem());
        adminMenu.getItems().add(fillPassports);
        adminMenu.getItems().add(fillDecimals);
